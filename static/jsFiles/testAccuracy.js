    ...
    fetch('/level2')
        .then(response => {
            if (response.ok) {
                ...
                console.error('Failed to call level2:', response.statusText);
            }
        })
        .catch(error => {
            console.error('Error calling level2:', error);
        });
    ...
    fetch('/level3')
        .then(response => {
            if (response.ok) {
                ...
                console.error('Failed to call level3:', response.statusText);
            }
        })
        .catch(error => {
            console.error('Error calling level3:', error);
        });
